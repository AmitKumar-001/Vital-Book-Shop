	...
	public static SessionFactory getSessionFactory() {
		if(sf == null)
		{
			try
			{
				...
				settings.put(Environment.URL, "jdbc:h2:tcp://localhost/~/BackEndTry2");
				...
				sources.addAnnotatedClass(ProductDetails.class);
				sources.addAnnotatedClass(Customer.class);
				sources.addAnnotatedClass(CustomerDetails.class);
			...
			{
				ex.printStackTrace();
				System.out.println("This comes form HibernateUtil.java");
			}
		}
		return sf;
	}
